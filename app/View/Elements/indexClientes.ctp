...
$imprimirClientesButton = '';
if (!empty($clientes)) {
    $imprimirClientesButton .= $this->fetch('imprimirClientesButton');
}
...
$filtroBar = $this->Html->div('row mb-3 mt-3', 
    ...
    $this->Html->div('col-md-2', $imprimirClientesButton) 
);
...
echo $this->element('modalCliente'); 
$this->Js->buffer('modalAlertaClientes();');
