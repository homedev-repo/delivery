...
<html lang="en" >
    ...
    <head>
        ...
        <title>Metronic | List Datatable</title>
        ...
        echo $this->Html->css('Metronic/dark.css');
        
        echo $this->Html->css('Metronic/dark2.css');
        echo $this->Html->css('Metronic/font.css');
        echo $this->Html->css('Metronic/fullcalendar.budle.css');
        echo $this->Html->css('Metronic/projeto.css');
        echo $this->Html->css('Metronic/light2.css');
        echo $this->Html->css('Metronic/menulight.css');
        echo $this->Html->css('Metronic/plugins.bundle.css');
        echo $this->Html->css('Metronic/style.bundle.css');
        echo $this->Html->css('Metronic/themelight.css');
        echo $this->Html->css('Metronic/dashboard.css');
        echo $this->Html->css('Metronic/tooltioHint.css');
        echo $this->Html->css('Metronic/wizard.css');
...
<div class="kt-aside__brand-logo">
        ...
        <?php echo $this->Html->image('/img/vayronBranca.png', array('class' => 'tamanho-imagem-vayronIconeMobile'));
        ?>
		</a>
	</div>
...
<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
    ...
    <?php
        $nomeFantasia = AuthComponent::user()['Estabelecimento']['nome_fantasia'];
        $estabelecimentoCodigo = AuthComponent::user()['Estabelecimento']['codigo'];
  
    ?>
    <h3 style="padding-top: 15px;"><?php echo $nomeFantasia . ' | '. $estabelecimentoCodigo ?></h3>
	</div>
</div>
<!-- end:: Header Menu -->
		<!-- begin:: Header Topbar -->
...
<div id="onClickNotificacoesLoad" class="kt-header__topbar-item dropdown">
        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="30px,0px" aria-expanded="true">
            <span class="kt-header__topbar-icon kt-pulse kt-pulse--brand" id="bota-notifcacao">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
            <form>
                <!--begin: Head -->
    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(/Vayron/app/webroot/img/menuLoginUsuario.jpg);">
        <h3 class="kt-head__title">
            Notificações
            &nbsp;
            <?php if ($notificacoesContagem == 0){
                $notificacoesContagem = 0;
            } ?>
            <span class="btn btn-success btn-sm btn-bold btn-font-md"><?php echo $notificacoesContagem?></span>
        </h3>
        <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x" role="tablist"></ul>
    </div>
<!--end: Head -->
...
<div class="kt-header__topbar-item kt-header__topbar-item--user">    
        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
            ...
            <span style="width: 77px;" class="kt-header__topbar-welcome kt-hidden-mobile "><?php echo saudacao();?>,</span>
            <span class="kt-header__topbar-username kt-hidden-mobile"><?php echo strstr($usuarioLogado, ' ', true); ?></span>
            <?php echo $this->Html->tag('i', '', array('class' => 'fas fa-user kt-menu__link-icon settings-text-submenu'))
                    . $this->Html->tag('span', '', array('class' => 'offset-md-1 settings-text-submenu kt-menu__link-text'))
            ?>
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
        <!--begin: Head -->
    <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(/Vayron/app/webroot/img/menuLoginUsuario.jpg);">
        ...
        <div class="kt-user-card__badge">
            <span class="btn btn-success btn-sm btn-bold btn-font-md"><?php echo $notificacoesContagem?> Notificações</span>
        </div>
    </div>
<!--end: Head -->
...
<div class="kt-notification">
    ...
    <div class="kt-notification__custom kt-space-between">
        <?php
          echo $this->Html->link('Sair', '/usuarios/logout', array('escape' => false, 'class' => 'btn btn-label btn-label-brand btn-sm btn-bold'));
        ?>
    </div>
</div>
<!--end: Navigation -->
...
<?php
    echo $this->Html->script('Metronic/jquery-3.4.1'); //Buffer|Todo projeto|
    echo $this->Html->script('Metronic/projeto.js');
    echo $this->Html->script('Metronic/plugins.js');
    echo $this->Html->script('Metronic/scrollSubMenu.js');
    echo $this->Html->script('Metronic/multipleSelect.js');
    echo $this->Html->script('Metronic/fontawesome.js');
    echo $this->Html->script('Metronic/jqueryInputMask.js');
