...
<div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
  ...
  <h2 style="font-family: Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-weight: 500;font-size: 20px;color: #4F545C;letter-spacing: 0.27px;">Parabéns, <?php echo $first_name?></h2>
<p>Você ganhou um Cupom de Desconto para ser utilizado no aplicativo <b><?php echo $estabelecimento?></b></p>
<p>Codigo Cupom: <b><?php echo $numero_cupom?></b></p>
<p>Validade: <b><?php echo $validade?></b></p>
